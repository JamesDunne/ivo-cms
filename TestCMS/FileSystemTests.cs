...
namespace TestCMS
{
    ...
    public class FileSystemTests
    {
        ...
        [TestMethod]
        public void TestImportTemplateFail2() { getTestMethods().TestImportTemplateFail2().Wait(); }

        [TestMethod]
        public void TestImportTemplateFail3() { getTestMethods().TestImportTemplateFail3().Wait(); }
